...
for region_code in region_codes:
    ...
    for feed_in in response['feedIn']['list']:
        formatted_entry = {
            ...
            "numberOfInstallations": int(feed_in.get("numberOfInstallations")) if feed_in.get("numberOfInstallations") else None,
            "installedCapacity": float(feed_in.get("installedCapacity")) if feed_in.get("installedCapacity") else None,
            "autarky": autarky,
            "dailyCo2Savings": daily_co2_savings
        }
